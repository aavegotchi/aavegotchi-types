...
export interface ERC721WithMultiRoyaltiesInterface extends utils.Interface {
  functions: {
...
export interface ERC721WithMultiRoyalties extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WithMultiRoyaltiesInterface;
