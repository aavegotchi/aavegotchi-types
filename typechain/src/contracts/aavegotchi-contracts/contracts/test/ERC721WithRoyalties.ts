...
export interface ERC721WithRoyaltiesInterface extends utils.Interface {
  functions: {
    ...
    "mintBatch(address[],address[],uint256[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "mintBatch"
      | "mintBatch(address[],address[],uint256[])"
      | "name"
      | "name()"
      | "ownerOf"
      | "ownerOf(uint256)"
  ...
  encodeFunctionData(
    functionFragment: "mintBatch(address[],address[],uint256[])",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[]
...
export interface ERC721WithRoyalties extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721WithRoyaltiesInterface;
  ...
  functions: {
    ...
    mintBatch(
      ...
      royaltyRecipients: PromiseOrValue<string>[],
      royaltyValues: PromiseOrValue<BigNumberish>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
