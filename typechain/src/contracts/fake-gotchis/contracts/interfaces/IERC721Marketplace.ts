...
export interface IERC721MarketplaceInterface extends utils.Interface {
  functions: {
...
export interface IERC721Marketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721MarketplaceInterface;
