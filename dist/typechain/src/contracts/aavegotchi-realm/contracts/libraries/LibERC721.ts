...
export interface LibERC721Interface extends utils.Interface {
  ...
  events: {
    ...
    "MintParcel(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MintParcel"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "MintParcel(address,uint256)"
  ): EventFragment;
...
export interface MintParcelEventObject {
  _owner: string;
  _tokenId: BigNumber;
}
export type MintParcelEvent = TypedEvent<
  [string, BigNumber],
  MintParcelEventObject
>;

export type MintParcelEventFilter = TypedEventFilter<MintParcelEvent>;
...
export interface LibERC721 extends BaseContract {
  ...
  filters: {
    ...
    "MintParcel(address,uint256)"(
      _owner?: PromiseOrValue<string> | null,
      _tokenId?: PromiseOrValue<BigNumberish> | null
    ): MintParcelEventFilter;
    MintParcel(
      _owner?: PromiseOrValue<string> | null,
      _tokenId?: PromiseOrValue<BigNumberish> | null
    ): MintParcelEventFilter;
