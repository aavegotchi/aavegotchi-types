...
export interface ItemsFacetInterface extends utils.Interface {
  functions: {
    ...
    "balancesWithItemTypes(address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "balancesWithItemTypes"
      | "balancesWithItemTypes(address)"
      | "isApprovedForAll"
  ...
  encodeFunctionData(
    functionFragment: "balancesWithItemTypes",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "balancesWithItemTypes(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
