...
export interface GHSTStakingTokenFacetInterface extends utils.Interface {
  functions: {
...
export interface GHSTStakingTokenFacet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GHSTStakingTokenFacetInterface;
